...
<div class="container">
    ...
    @endif
    <div class="row">
        <form class="form-horizontal needs-validation col-lg-12 col-md-12" novalidate id="source-form"
            action="{{route('product.source.store')}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input id="product_url" name="product_url" type="text" placeholder="Enter Alibaba URL"
